...
def DqnsGenUdmDeviceFileIni(device_name,path_name,is_h_file=True):
    ...
    if is_h_file == True:
        ...
        device_file_list.append('\n')
        device_file_list.append('static void Udm'+device_name_first_upper+'Init(void);\n')
        device_file_list.append('static TE_UDM_RET_CODE Udm'+device_name_first_upper+'Open(T_UDM_OPEN_MODE open_mode);\n')
        device_file_list.append('static TE_UDM_RET_CODE Udm'+device_name_first_upper+'Close(void);\n')
        device_file_list.append('static TE_UDM_RET_CODE Udm'+device_name_first_upper+'Read(T_UDM_START_ADDR start_addr,T_UDM_LEN len,void * p_data);\n')
        device_file_list.append('static TE_UDM_RET_CODE Udm'+device_name_first_upper+'Write(T_UDM_START_ADDR start_addr,T_UDM_LEN len,void * p_data);\n')
        device_file_list.append('static TE_UDM_RET_CODE Udm'+device_name_first_upper+'IOCtl(void * p_data);\n')
        device_file_list.append('\n')
        device_file_list.append('#ifdef __cplusplus\n')
        device_file_list.append('}\n')
        device_file_list.append('#endif\n')
    ...
    #初始化udm设备源文件
        ...
        device_file_list.append('    gg_udm_'+device_name+'.p_fn_init = Udm'+device_name_first_upper+'Init;\n')
        device_file_list.append('    gg_udm_'+device_name+'.p_fn_open = Udm'+device_name_first_upper+'Open;\n')
        device_file_list.append('    gg_udm_'+device_name+'.p_fn_close = Udm'+device_name_first_upper+'Close;\n')
        device_file_list.append('    gg_udm_'+device_name+'.p_fn_read = Udm'+device_name_first_upper+'Read;\n')
        device_file_list.append('    gg_udm_'+device_name+'.p_fn_write = Udm'+device_name_first_upper+'Write;\n')
        device_file_list.append('    gg_udm_'+device_name+'.p_fn_ioctl = Udm'+device_name_first_upper+'IOCtl;\n')
        device_file_list.append('}\n')
        device_file_list.append('\n')
        device_file_list.append('static TE_UDM_RET_CODE Udm'+device_name_first_upper+'Open(T_UDM_OPEN_MODE open_mode){\n')
